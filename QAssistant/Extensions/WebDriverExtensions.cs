...
namespace QAssistant.Extensions
{
    public static class WebDriverExtensions
    {
        ...
        /// <summary>
        /// Finds the first <see cref="T:OpenQA.Selenium.IWebElement" /> using the given condition.
        /// </summary>
        /// <param name="driver">The <see cref="IWebDriver"/>.</param>
        /// <param name="condition">A delegate taking a TSource as its parameter, and returning a TResult.</param>
        /// <returns>The first matching <see cref="T:OpenQA.Selenium.IWebElement" /> on the current context.</returns>
        public static IWebElement WaitUntilFindElement(this IWebDriver driver, Func<IWebDriver, IWebElement> condition)
        {
            return driver.Wait().Until(condition);
        }
        ...
        /// <param name="driver">The <see cref="IWebDriver"/>.</param>
        /// <param name="locator">The locating mechanism to use.</param>
        /// <returns>A <see cref="T:System.Collections.ObjectModel.ReadOnlyCollection`1" /> of all Displayed <see cref="T:OpenQA.Selenium.IWebElement">WebElements</see>
        /// which matches the current criteria, or an empty list if nothing matches.</returns>
        ...
        /// <summary>
        /// Waits until a condition is true or times out and finds the first <see cref="T:OpenQA.Selenium.IWebElement" /> using the given method. 
        /// </summary>
        /// <param name="driver">The <see cref="IWebDriver"/>.</param>
        /// <param name="selector">The locating mechanism to use.</param>
        /// <param name="condition">A delegate taking a TSource as its parameter, and returning a TResult.</param>
        /// <returns>The first matching <see cref="T:OpenQA.Selenium.IWebElement" /> on the current context.</returns>
        public static IWebElement WaitUntilPageLoad(this IWebDriver driver, By selector, Func<IWebDriver, IWebElement> condition)
        {
        ...
        /// <summary>
        /// Waits until an element is no longer attached to the DOM, then waits until page title matches the passed parameter and then execute WaitUntilHtmlTagLoads,
        /// where it finds the first <see cref="T:OpenQA.Selenium.IWebElement" /> using the given method.
        /// </summary>
        /// <param name="driver">The <see cref="IWebDriver"/>.</param>
        /// <param name="titleOnNewPage">Title of the page</param>
        ...
        /// <param name="driver">The <see cref="IWebDriver"/>.</param>
        /// <returns>The <see cref="IWebElement"/> of html tag.</returns>
        private static IWebElement WaitUntilHtmlTagLoads(this IWebDriver driver) => driver.WaitUntilFindElement(By.XPath("html"));
